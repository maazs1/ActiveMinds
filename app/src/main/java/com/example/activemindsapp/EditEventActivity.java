...
public class EditEventActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference = db.collection("Users Account").document(moodEvent.getAuthor());
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (uploadTask != null && uploadTask.isInProgress()) {
                    ...
                    Toast.makeText(EditEventActivity.this,"Reason should be no more than 30 characters", Toast.LENGTH_LONG).show();
...
*/
    ...
    private void submitMoodEventToDB(DocumentReference documentReference, MoodEvent moodEvent){
        ...
        Intent intent = new Intent(EditEventActivity.this, UserPage.class);
